                    ...
                    <div id="mytasks" class="tab-pane fade in active">
                        <script>
                            function markComplete() {
                                var checkboxes = document.querySelectorAll('.todo-done');
                        ...
                        <div class="row m-b-20">
                            <div class="col-md-12">
                                <div class="pull-right">
                                    <button type="button" class="btn btn-primary waves-effect waves-light" onclick="markComplete()">Mark as complete</button>
                                </div>
                            </div>
                        </div>
                        <div class=" row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="input-group col-md-8">
                                                    <input type="text" class="form-control date-input" placeholder="mm/dd/yyyy" id="datepicker">
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    $(".new-task-btn").click(function() {
                                        $("html, body").animate({
                                            scrollTop: $(".new-task_panel").offset().top
                                        }, 1000); 
                                    });

                                    $(".create-btn").click(function(e) {
                                        e.preventDefault(); 
                                        var taskName = $(".form-control").val();
                                        var description = $(".form-control").val();
                                        var dueDate = $(".date-input").val();

                                        // Create a new task panel
                                        var newTaskPanel = `
                                            <div class="col-sm-6 col-md-4">
                                                <div class="panel" style="cursor: pointer;">
                                                    <p>Fill out text till i get it working</p>
                                                </div>
                                            </div>
                                        `;

                                        $(".created-tasks").append(newTaskPanel);
